...
class TestRedisConfig:
    ...
    def test_redis_config_default_values(self) -> None:
        """Test that Redis config has proper default values."""
        config = RedisConfig()
    ...
    def test_redis_config_from_environment(self, monkeypatch: pytest.MonkeyPatch) -> None:
        """Test that Redis config loads from environment variables."""
    ...
    def test_redis_url_property_without_password(self, monkeypatch: pytest.MonkeyPatch) -> None:
    ...
    def test_redis_url_property_with_password(self, monkeypatch: pytest.MonkeyPatch) -> None:
    ...
    def test_redis_config_validation_negative_port(self, monkeypatch: pytest.MonkeyPatch) -> None:
    ...
    def test_redis_config_validation_port_too_high(self, monkeypatch: pytest.MonkeyPatch) -> None:
    ...
    def test_redis_config_validation_negative_db(self, monkeypatch: pytest.MonkeyPatch) -> None:
    ...
    def test_redis_config_validation_max_connections_too_low(self, monkeypatch: pytest.MonkeyPatch) -> None:
    ...
    def test_redis_config_str_representation(self, monkeypatch: pytest.MonkeyPatch) -> None:
...
class TestRedisConfigIntegration:
    ...
    def test_development_configuration_integration(self, monkeypatch: pytest.MonkeyPatch) -> None:
    ...
    def test_production_configuration_integration(self, monkeypatch: pytest.MonkeyPatch) -> None:
    ...
    def test_config_with_all_environment_variables(self, monkeypatch: pytest.MonkeyPatch) -> None:
