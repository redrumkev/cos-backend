...
class BaseLog(Base):
    ...
    prompt_traces: Mapped[list["PromptTrace"]] = relationship(
        "src.backend.cc.mem0_models.PromptTrace", back_populates="base_log", cascade="all, delete-orphan"
    )
    event_logs: Mapped[list["EventLog"]] = relationship(
        "src.backend.cc.mem0_models.EventLog", back_populates="base_log", cascade="all, delete-orphan"
    )
...
class PromptTrace(Base):
    ...
    base_log: Mapped["BaseLog"] = relationship("src.backend.cc.mem0_models.BaseLog", back_populates="prompt_traces")
...
class EventLog(Base):
    ...
    # Relationship to parent BaseLog
    base_log: Mapped["BaseLog"] = relationship("src.backend.cc.mem0_models.BaseLog", back_populates="event_logs")
