...
class TestGraphRegistry:
    ...
    def test_format_labels_for_cypher(self):
    ...
    def test_create_node_query_basic(self):
    ...
    def test_create_node_query_with_properties(self):
    ...
    def test_create_node_query_no_return(self):
    ...
    def test_match_node_query_basic(self):
    ...
    def test_match_node_query_with_where(self):
    ...
    def test_create_relationship_query_basic(self):
    ...
    def test_create_relationship_query_with_conditions(self):
    ...
    def test_validate_node_structure_invalid_node_type(self):
    ...
    def test_validate_node_structure_invalid_module(self):
